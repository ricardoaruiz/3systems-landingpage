  ...
  return (
    <section
      className={cn(
        ...
        "h-screen justify-start lg:justify-center lg:gap-8 lg:px-2",
        className,
    ...
    >
      ...
      <div className="relative z-10 flex w-full flex-1 flex-col items-center gap-8 px-2 lg:justify-center lg:gap-10 lg:px-5">
        {logo && (
          <div className="relative mt-25 mb-20 h-[82px] w-[250px] md:h-[165px] md:w-[500px] lg:mt-0">
            <Image
              alt={logo.altText}
              fill
